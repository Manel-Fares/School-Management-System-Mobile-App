...
public class ReclamationForm extends Form {
    ...
    public ReclamationForm(String charr) {
                ...
                send.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        if (cmmnt.getText().compareTo("") != 0) {
                            ...
                            removeAll();
                            new ReclamationForm(chType.getSelectedItem().toString()).show();
        ...
        chType.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if (chType.getSelectedItem().equals("Note")) {
                    removeAll();
                    new ReclamationForm("Note").show();
                } else if (chType.getSelectedItem().equals("Enseignant")) {
                    removeAll();
                    new ReclamationForm("Enseignant").show();
                } else {
                    removeAll();
