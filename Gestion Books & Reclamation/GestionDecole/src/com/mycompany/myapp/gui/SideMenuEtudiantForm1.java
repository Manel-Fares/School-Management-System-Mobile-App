...
public abstract class SideMenuEtudiantForm1 extends Form {
    ...
    public void setupSideMenu(Resources res) {
       ...
       // getToolbar().addMaterialCommandToSideMenu("  Result", FontImage.MATERIAL_TRENDING_UP,  e -> new listeNoteEtudiants(res).show());
       // getToolbar().addMaterialCommandToSideMenu("  Events ", FontImage.MATERIAL_ACCESS_TIME, e -> new AjoutNoteForm(res).show());
        getToolbar().addMaterialCommandToSideMenu("  Books ", FontImage.MATERIAL_ACCESS_TIME, e -> new BooksForm(res).show());
       // getToolbar().addMaterialCommandToSideMenu("  Classes ", FontImage.MATERIAL_SETTINGS, e -> new LoginForm(res).show());
