 ...
 * @author Neifos
 */
public class BooksForm extends Form {
...
*/
    public void refresh(Books b){
           ...
           Label lbTitre = new Label();
            ...
            lbTitre.getUnselectedStyle().setFont(largeBoldSystemFont);
            lbDescription.getTextAllStyles().setFont(smallPlainMonospaceFont);
            Font mediumItalicSystemFont = Font.createSystemFont(Font.FACE_SYSTEM, Font.STYLE_BOLD, Font.SIZE_MEDIUM);
            booking.getUnselectedStyle().setFont(mediumItalicSystemFont);
    ...
    public BooksForm(Resources theme) {
        ...
        getToolbar().addCommandToOverflowMenu("My stat", null, new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                BooksStat bbb = new BooksStat();
                bbb.createPieChartForm().show();
