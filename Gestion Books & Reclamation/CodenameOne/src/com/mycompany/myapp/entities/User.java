...
private static User currentuser=new User();
    protected static String currentId, currentUsername,  currentPassword, currentNom, currentPrenom, currentEmail, currentPic;
    protected static int currentNumTelUser,currentCin;

    public static void setCurrentNumTelUser(int currentNumTelUser) {
        User.currentNumTelUser = currentNumTelUser;
    }
    ...
    public static int getCurrentNumTelUser() {
        return currentNumTelUser;
    }
    
    

    public User(String id, int cinUser, String username, String nomUser, String prenomUser, String email, int numTelUser, String sexeUser, String password, String roleUser) {
        this.id = id;
    ...
    public User(String id, int cinUser, String username, String nomUser, String email, String password, String roleUser) {
        this.id = id;
        this.cinUser = cinUser;
        this.username = username;
        this.nomUser = nomUser;
