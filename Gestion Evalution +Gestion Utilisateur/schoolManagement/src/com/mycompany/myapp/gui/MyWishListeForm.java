 ...
 * @author Neifos
 */
public class MyWishListeForm extends SideMenuEtudiantForm1{

    public MyWishListeForm(Resources res) {
         super(BoxLayout.y());
          ...
          int idd = (int)Float.parseFloat(b.getUser().getId());
           if (idd== id) {
             ...
             FontImage.setMaterialIcon(delete, FontImage.MATERIAL_DELETE, 3);
                ...
                Image placeholder = Image.createImage(deviceWidth/15, deviceWidth /15, 0xbfc9d2); //square image set to 10% of screen width
