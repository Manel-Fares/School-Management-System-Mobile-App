 ...
 * @author asus
 */
public class chartsEvenementsForm extends SideMenuEtudiantForm1 {
    ...
    protected CategorySeries buildCategoryDataset(String title) {
        ...
        Evenements = ServiceParticipation.getInstance().getEeventNbrParticipation();
       for (Map.Entry<Evenement, Integer> entry : Evenements.entrySet()) {
            series.add("Organised by: "+entry.getKey().getIdClub().getNomClub(),entry.getValue());
        }
     ...
     */
    public chartsEvenementsForm(Resources res) {
        super(BoxLayout.y());
