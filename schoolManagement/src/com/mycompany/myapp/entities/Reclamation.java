...
public class Reclamation {
    ...
    public Reclamation(int idReclamation, String sujetReclamation, String descriptionReclamation,String statutReclamation,Date dateCreation,User u) {
    ...
    public Reclamation(String sujetReclamation, String descriptionReclamation, String statutReclamation, Date dateCreation,User u) {
        this.sujetReclamation = sujetReclamation;
        this.descriptionReclamation = descriptionReclamation;
        this.statutReclamation = statutReclamation;
        this.dateCreation = dateCreation;
    ...
    public String toString() {
        return "Reclamation{" + "idReclamation=" + idReclamation + ", sujetReclamation=" + sujetReclamation + ", descriptionReclamation=" + descriptionReclamation + ", statutReclamation=" + statutReclamation + ", dateCreation=" + dateCreation + ",User:"+user.toString()+ '}';
    }
